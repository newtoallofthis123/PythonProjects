...
try:
    ...
    photo = PhotoImage(file = "/NSPlayer.png")
    ...
    print("sorry, something went wrong, refer to troubleshoot.txt for more info, you can find it at /assets/error/troubleshoot.txt")
    config = tk.Tk()
    config.title("Something went wrong, refer to troubleshoot.txt for more info, you can find it at /assets/error/troubleshoot.txt")
    config.minsize(900, 10)
    config.configure(bg="black")
    er = tk.Label(config, text="sorry, something went wrong, refer to assets/error/troubleshoot.txt", fg="white", font=("Cascadia Code", 24)) 
